...
`parse-csv` is a menu-driven DuckDB toolkit for exploring Lee County property data and similar spreadsheet exports. The current repo centers on `analyze_csv.sh`, plus Python helpers for Florida DFS searching and spreadsheet-safe logging.
